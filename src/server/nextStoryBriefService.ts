...
{"themeSuggestion":"broad English theme, 1-5 words, or empty string","narrativeScale":"minimal|simple","language":{"focus":"one concise English language objective","progression":"reinforce|advance","complexity":"simpler|similar|harder","calibrationSnippets":["exact German excerpt from the completed story"]},"recentStory":{"motif":"completed story's central situation","protagonist":"completed story's protagonist type","setting":"completed story's main setting","elements":["key object or plot mechanism"]}}
