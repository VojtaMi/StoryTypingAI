...
/**
 * The sentence block as one string. This is also its audio cache key, so it must
 * keep matching `lessonNarratableTexts(lesson)[0]` — the block is narrated
 * whole, not per sentence, which would multiply TTS calls by five.
 */
