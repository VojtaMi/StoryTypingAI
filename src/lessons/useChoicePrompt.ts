...
/**
 * The pick-one-of-N mechanic shared by the lesson's fill-blank exercise and the
 * story recap's fill-missing-word and story-question exercises: shuffle the
 ...
 * three exercises stacked on one page, the brick steps through prompts full
 * screen, and neither shell belongs in here.
 */
